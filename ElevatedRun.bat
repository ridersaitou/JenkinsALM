...
:Enter_the_path
SET /P "[Path]= --> Please key in (or copy and paste) the full path (without quotation marks) of the          application file (for example C:\Windows\System32\cmd.exe) and then press [Enter]:        " 

Set "P=""%[Path]%"""
Set "(P)=%P: ""=""%"
Set "[P]=%P:"" =""%"
If not "%P%"=="%(P)%" (Echo. & Echo %[M]% & Echo. & Goto Enter_the_path)
If not "%P%"=="%[P]%" (Echo. & Echo %[M]% & Echo. & Goto Enter_the_path)
echo.
